    ...
    <div class="flex min-w-full min-h-screen">
        <div class="w-[100%] lg:w-[75%] bg-gray-300 p-2 space-y-4 lg:p-2 md:space-y-0">
            <div class="flex justify-between">
                <div class="flex flex-1 justify-between  lg:justify-start p-2 mx-2  rounded-md  bg-sky-900 text-gray-50">
            ...
            <div class="py-2 flex flex-col space-y-2">
                <div class="border bg-gray-50 p-2 rounded-md">
                    ...
                    <div v-for="(project, index) in projects" :key="index" class="lg:text-lg text-sm leading-8">
                           ...
                           <p class="text-xs lg:text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione laudantium sint doloribus earum numquam impedit minima ea praesentium qui sit error quod quidem, esse id alias, exercitationem, quisquam asperiores dolor.</p>
                    </div>
                </div>
